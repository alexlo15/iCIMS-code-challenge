...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("#statbar {\n  margin-right: 15px;\n}\n\n#company {\n  float: right;\n}\n\n#cards {\n  width: 80vw;\n  background-color: rgba(158, 158, 158, 0.315);\n  font-size: 25px;\n}\n\nmat-expansion-panel:active {\n  background-color: #1ca9d4;\n}\n\ninput {\n  background-color: white;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let JobsComponent = class JobsComponent {
    ...
    ngOnInit() {
        ...
        this.filterOptions = this.myControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(value => (this._filter(value))));
    }
    ;
    _filter(value) {
...
let MyFilterPipe = class MyFilterPipe {
    transform(items, filter) {
        ...
        return items.filter(item => item.data.title.indexOf(filter) !== -1);
    }
};
...
let SinglejobpageComponent = class SinglejobpageComponent {
...
SinglejobpageComponent.ctorParameters = () => [
